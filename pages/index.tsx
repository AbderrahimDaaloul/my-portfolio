...
export default function HomePage() {
  ...
  const codeLines = [
    { code: 'const Portfolio = {', type: 'function' },
    {
      code: '  developer: {',
      type: 'variable',
    },
    { code: "    name: 'Daaloul Abderrahim',", type: 'array-item' },
    { code: "    role: 'Full Stack Developer',", type: 'array-item' },
    { code: "    passion: 'Building Modern Web Experiences',", type: 'array-item' },
    { code: '  },', type: 'array-end' },
    { code: '', type: 'blank' },
    { code: '  skills: [', type: 'nested-function' },
    {
      code: "    'React', 'Next.js', 'TypeScript',",
      type: 'return',
    },
    { code: "    'Tailwind CSS', 'Node.js', 'MongoDB'", type: 'function-call' },
    { code: '  ],', type: 'close' },
    { code: '', type: 'blank' },
    { code: '  journey: {', type: 'return-object' },
    { code: '    focus: "User Experience & Clean Code",', type: 'object-method' },
    { code: '    goal: "Deliver Exceptional Solutions"', type: 'object-method' },
    { code: '  }', type: 'array-end' },
    { code: '', type: 'blank' },
    { code: '};', type: 'close-function' },
    { code: '', type: 'blank' },
    { code: 'export default Portfolio;', type: 'function-call' },
  ];
      ...
      <div className={styles.container}>
        ...
        <div className={styles.infoSection}>
          <h1 className={styles.developerName}>
            Daaloul <span className={styles.accentText}>Abderrahim</span>
          </h1>
